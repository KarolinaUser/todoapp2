...
@NgModule({ imports: [AngularFirestoreModule],
  	declarations: [],
  	providers: [FirebaseTestService, { provide: ADDS_TASK_DTO, useExisting: FirebaseTestService }, { provide: GETS_ALL_TASK_DTO, useExisting: FirebaseTestService }, { provide: REMOVES_TASK_DTO, useExisting: FirebaseTestService }, { provide: SETS_TASK_DTO, useExisting: FirebaseTestService }],
  	exports: [] })
